...
// File: contracts/N30.sol

contract N30 is ERC20Token, Pausable, ERC223{

    using SafeMath for uint;

    string public constant name = "N30";
    string public constant symbol = "N30";
    ...
    function N30() public {
        _tokenSupply = 0;
        _totalSupply = 3000000000 * (uint256(10) ** decimals);
